...
const initWebRouter = (app) => {
  ...
  router.get(
    "/api/webapi/listCommission",
    middlewareController,
    promotionController.listCommission,
  ); // register
  ...
  router.post(
    "/api/webapi/manager/listCommission",
    dailyController.middlewareDailyController,
  ...
  router.get(
    ...
    adminController.middlewareAdminController,
    adminController.commissionPage,
  );
  ...
  router.post(
    "/api/webapi/admin/fetchMemberDetails",
    adminController.middlewareAdminController,
    adminController.fetchMemberDetails,
  ); // get info account

  router.post(
    "/api/webapi/admin/updateMemberDetails",
    adminController.middlewareAdminController,
